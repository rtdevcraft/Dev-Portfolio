...
const getCachedElements = () => ({
    ...
    toolboxHeaderImage: document.querySelector('#toolbox .header-image'),
    ...
    toolboxMarquee: document.querySelector('.toolbox__marquee'),
});
alert('whyyyyyyyyyyyy?');
// Helper functions
...
// Toolbox Marquee
const tools = [
    { name: 'HTML', logo: '/assets/images/HTMLlogo.png' },
    { name: 'CSS', logo: '/assets/images/CSSlogo.png' },
    { name: 'Javascript', logo: '/assets/images/JSlogo.png' },
    { name: 'Typescript', logo: '/assets/images/TSlogo.png' },
    { name: 'React', logo: '/assets/images/Reactlogo.png' },
    { name: 'Tailwind CSS', logo: '/assets/images/Tailwindlogo.png' },
    { name: 'Bootstrap', logo: '/assets/images/Bootstraplogo.png' },
    { name: 'React Router', logo: '/assets/images/ReactRouterlogo.png' },
    { name: 'Adobe CC', logo: '/assets/images/CClogo.png' },
    { name: 'Figma', logo: '/assets/images/Figmalogo.png' },
    { name: 'Canva', logo: '/assets/images/Canvalogo.png' },
    { name: 'GreenSock', logo: '/assets/images/GSlogo.png' },
    { name: 'Firebase', logo: '/assets/images/Firebaselogo.png' },
    { name: 'Vite', logo: '/assets/images/Vitelogo.png' },
    { name: 'Node.js', logo: '/assets/images/Nodelogo.png' },
    { name: 'Express', logo: '/assets/images/Expresslogo.png' },
    { name: 'MongoDB Atlas', logo: '/assets/images/MongoDBlogo.png' },
    { name: 'NoSQL', logo: '/assets/images/NoSQLlogo.png' },
    { name: 'Github', logo: '/assets/images/Githublogo.png' },
    { name: 'Netlify', logo: '/assets/images/Netlifylogo.png' },
    { name: 'Wordpress', logo: '/assets/images/Wordpresslogo.png' },
    { name: 'npm', logo: '/assets/images/npmlogo.png' },
    { name: 'Jest', logo: '/assets/images/Jest.png' },
    { name: 'Vitest', logo: '/assets/images/Vitest.png' },
    { name: 'ChatGPT', logo: '/assets/images/ChatGPTlogo.png' },
    { name: 'ClaudeAI', logo: '/assets/images/ClaudeAI.png' },
];
function createMarqueeGroup(isHidden = false) {
  ...
  `)
        .join('');
    return `
    <div class="marquee__group" ${isHidden ? 'aria-hidden="true"' : ''}>
      <ul>${toolItems}</ul>
    </div>
  `;
}
function renderToolbox() {
    console.log('renderToolbox function called');
    const existingToolbox = document.getElementById('toolbox');
    if (!existingToolbox) {
        console.error('Toolbox section not found in HTML. Make sure you have an element with id="toolbox"');
        return;
    }
    console.log('Existing toolbox found:', existingToolbox);
    // Ensure the existing toolbox has the correct class
    existingToolbox.className = 'toolbox';
    // Create the new content
    const newContent = `
    <img src="/assets/images/toolbox.jpg" alt="" class="header-image" />
    <h2 class="visually-hidden">My Toolbox</h2>
    <div class="toolbox__marquee" aria-label="Skills and Tools">
      ${createMarqueeGroup()}
      ${createMarqueeGroup(true)}
    </div>
  `;
    console.log('New content created:', newContent);
    // Update the content of the existing toolbox
    existingToolbox.innerHTML = newContent;
    console.log('Toolbox content updated');
}
function initToolbox() {
    console.log('initToolbox function called');
    renderToolbox();
}
// function createToolItem(tool: Tool): string {
//   return `
//     <li>
//       <img src="${tool.logo}" alt="${tool.name} logo" />
//       <h3>${tool.name}</h3>
...
//   `;
// }
// function createMarqueeGroup(isHidden: boolean = false): string {
//   const toolItems = tools.map(createToolItem).join('');
//   return `
//     <div class="marquee__group" ${isHidden ? 'aria-hidden="true"' : ''}>
//       <ul>${toolItems}</ul>
//     </div>
...
//   const existingToolbox = document.getElementById('toolbox');
//   if (!existingToolbox) {
//     console.error('Toolbox section not found in HTML');
//     return;
//   }
//   existingToolbox.className = 'toolbox';
//   existingToolbox.innerHTML = `
//     <img src="/assets/images/toolbox.jpg" alt="" class="header-image" />
//     <h2 class="visually-hidden">My Toolbox</h2>
//     <div class="toolbox__marquee" aria-label="Skills and Tools">
//       ${createMarqueeGroup()}
...
//   `;
// }
// // Update the initToolbox function
// function initToolbox(): void {
//   renderToolbox();
// }
...
const updateImages = (elements, theme) => {
    ...
    const imageMappings = [
        ...
        {
            element: elements.toolboxHeaderImage,
            prop: 'src',
            value: config.toolbox,
        },
        ...
        {
            element: elements.moreAboutImage,
            prop: 'src',
            value: config.moreAbout,
        },
        {
            element: elements.interestsImage,
            prop: 'src',
...
const init = () => {
    ...
    console.log('About to call initToolbox');
    initToolbox();
    // Event listeners
    document.querySelectorAll('.switch-theme').forEach((button) => {
